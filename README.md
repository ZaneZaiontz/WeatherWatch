...
* If you want to look at the weather for another City we have the Search Menu option which is the 4th button on the top of the app.
...
* The radar view is an interactive radar map over the users selected city.
...
* The Detailed Weather Information view allows user to see more detailed data about the selected city.
